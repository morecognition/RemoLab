...
class _ContractionsPageState extends State<ContractionsPage> {
  ...
  StreamSubscription<int>? _repetitionsSub;
  int _lastRepetitions = 0;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      context.read<ProportionalControlBloc>().add(
        PrepareRecordingBaseValue(_currentRmsStream()),
      );
    });
  }
    ...
    return BlocListener<ProportionalControlBloc, ProportionalControlState>(
      listener: (context, state) {
        ...
        if (state is Active) {
          ...
          _repetitionsSub?.cancel();
          _lastRepetitions = 0;
          _repetitionsSub = state.repetitionsStream.listen((count) {
            if (count > _lastRepetitions) {
              _lastRepetitions = count;
      ...
      builder: (context, state) {
        ...
        switch (state) {
          ...
          case BaseValueProportionalControlState baseValueState:
            return _buildRestCalibrationBody(
              context,
              baseValueState,
              rmsStream,
            );
          ...
          case PostMvcValue _:
            return _buildNextExerciseBody(
              ...
              remoState,
              () => context.read<ProportionalControlBloc>().add(
                PrepareProportionalControl(rmsStream),
              ),
              () => context.read<ProportionalControlBloc>().add(
                PrepareRecordingMvc(rmsStream),
              ),
  ...
  Widget _buildRestCalibrationBody(
    ...
    BaseValueProportionalControlState state,
    Stream<RmsData> rmsStream,
  ) {
    return Center(
      child: Column(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: const RadialGradient(
                    radius: 0.5,
                    colors: <Color>[Color(0x00FDBAB9), Color(0xCCFDBAB9)],
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: const RadialGradient(
                    radius: 0.5,
                    colors: <Color>[Color(0x00B3E4E6), Color(0xFFB3E3E5)],
              ...
              StreamBuilder(
                ...
                builder: (context, baseValue) {
                  return _drawBaseValueRing(
                    30.adaptedHeight,
                    246.adaptedHeight,
                    clampDouble((baseValue.data ?? 0) / maxBaseValue, 0, 1),
                  );
                },
              ),
            ],
  ...
  Widget _buildMaxCalibrationBody(
    BuildContext context,
    MvcProportionalControlState state,
    Stream<RmsData> rmsStream,
  ) {
    return Center(
      child: Column(
        ...
        children: [
          ...
          StreamBuilder(
            ...
            builder: (context, mvcValue) {
              var normalizedValue = clampDouble(
                (mvcValue.data ?? 0) / maxStrenghtValue,
                0,
                1,
              );
              return Stack(
  ...
  Widget _buildBiofeedbackBody(
    BuildContext context,
    FeedbackProportionalControlState state,
    Stream<RmsData> rmsStream,
  ) {
      ...
      child: Column(
        ...
        children: [
          ...
          state is Active
              ...
              : FilledButton(
                  onPressed: () => context.read<ProportionalControlBloc>().add(
                    StartProportionalControl(rmsStream),
                  ),
                  style: FilledButton.styleFrom(
                    fixedSize: Size(343.adaptedWidth, 48.adaptedHeight),
                    shape: RoundedRectangleBorder(
  ...
  Widget _buildNextExerciseBody(
    BuildContext context,
    RemoState remoState,
    VoidCallback? nextCallback,
    VoidCallback? repeatCallback,
  ) {
    return Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        ...
        children: [
          ...
          Image.asset('assets/mascotte.png'),
          Text(
    ...
    return Row(
      children: [
        ...
        FilledButton(
          ...
          style: FilledButton.styleFrom(
            fixedSize: Size(164.adaptedWidth, 32.adaptedHeight),
            shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.all(Radius.circular(25.adaptedRadius)),
            ),
            backgroundColor: const Color(0xFFE5F3F5),
          ),
          child: Text(
            AppLocalizations.of(context)!.graph_1,
            style: TextStyle(
              fontSize: 20.adaptedFontSize,
              fontWeight: FontWeight.w500,
